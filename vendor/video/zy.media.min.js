!function() {
    ...
    function h(a) {
        var b, c;
        switch (a = a.toLowerCase().split("?")[0],
        b = a.substring(a.lastIndexOf(".") + 1),
        c = /mp4|m4v|ogg|ogv|m3u8|webm|webmv|wmv|mpeg|mov/gi.test(b) ? "video/" : "../audio/moni/",
        b) {
            case "mp4":
            case "m4v":
            case "m4a":
    ...
    function j(b, c, d) {
        ...
        if (c.type)
            ...
            for (f = 0; f < b.children.length; f++)
                g = b.children[f],
                1 == g.nodeType && "source" == g.tagName.toLowerCase() && (d = g.getAttribute("src"),
                e.push({
    ...
    function(a) {
        ...
        a.hasOldNativeFullScreen && /mac os x 10_5/i.test(b) && (a.nativeFullscreenPrefix = "-",
        a.hasOldNativeFullScreen = !1)
    }(a.features = {}),
    k = 0,
    a.players = {},
    a.MediaPlayer = function(b, c) {
        var e, f, g, i, d = this;
        if (!b.isInstantiated && (b.isInstantiated = !0,
        d.media = b,
        f = d.media.tagName.toLowerCase(),
        /audio|video/.test(f))) {
            d.isVideo = "video" === f,
            d.options = {};
            for (e in a.config)
                d.options[e] = a.config[e];
            try {
                for (e in c)
                    d.options[e] = c[e];
            ...
            d.options.nativeControls || a.features.isVendorControls ? d.media.setAttribute("controls", "controls") : (i = d.media.getAttribute("src"),
            i = "" === i ? null : i,
            j(d.media, d.options, i) ? (d.id = "zym_" + k++,
            a.players[d.id] = d,
            d.init()) : alert("不支持此" + (d.isVideo ? "视" : "音") + "频"))
        }
    }
    ,
    a.MediaPlayer.prototype = {
        ...
        setPlayerSize: function(a) {
            ...
            a > e && (d.width = e),
            d.enableAutoSize && (f = d.media.videoWidth,
            g = d.media.videoHeight,
            f && g && Math.abs(d.options.aspectRation - f / g) < .1 && (d.options.aspectRation = f / g),
            d.height = parseInt(e / d.options.aspectRation)),
            d.container.style.width = d.width + "px";
            //if (d.isFullScreen) {
            //    d.media.style.height = d.container.style.height = (d.height - 42) + "px"
            //} else {
        ...
        showControls: function() {
            var a = this;
            a.isControlsVisible || (a.controls.style.bottom = 0,
            a.options.mediaTitle && (a.title.style.top = 0),
            a.isControlsVisible = !0)
        },
        hideControls: function() {
            var a = this;
            a.isControlsVisible && !a.options.alwaysShowControls && (a.controls.style.bottom = "-45px",
            a.options.mediaTitle && (a.title.style.top = "-35px"),
        ...
        updateTimeline: function(a) {
            ...
            null !== e && (e = Math.min(1, Math.max(0, e)),
            c.loaded.style.width = f * e + "px",
            c.media.paused && setTimeout(function() {
                c.loaded.style.width = f * e + "px",
                c.updateTimeline()
            }, 300)),
            void 0 !== c.media.currentTime && c.media.duration && (g = Math.round(f * c.media.currentTime / c.media.duration),
            c.current.style.width = g + "px",
            c.handle.style.left = g - Math.round(b(c.handle, "width") / 2) + "px")
        },
        updateTime: function() {
            var a = this;
        ...
        enterFullScreen: function() {
            var c = this;
            //if (c.normalHeight = b(c.container, "height"),
            //c.normalWidth = b(c.container, "width"),
            //"-" != a.features.nativeFullscreenPrefix)
            //    c.container[a.features.nativeFullscreenPrefix + "RequestFullScreen"]();
            //else if (a.features.hasOldNativeFullScreen)
            //    return c.media.webkitEnterFullscreen(),
            //    void 0;
            ...
            //c.setPlayerSize();
            $('.zy_media').removeAttr("style");
            $("video").css({ "height": conW + "px" })
            $('.zy_media').css({
        ...
        exitFullScreen: function() {
            var b = this;
            //(g() || b.isFullScreen) && ("-" != a.features.nativeFullscreenPrefix ? document[a.features.nativeFullscreenPrefix + "CancelFullScreen"]() : a.features.hasOldNativeFullScreen && document.webkitExitFullscreen()),
        ...
        buildContainer: function() {
            ...
            a.isVideo && (a.width = a.options.videoWidth,
            a.height = a.options.videoHeight,
            "100%" == a.width && "auto" == a.height && (a.enableAutoSize = !0),
            a.setPlayerSize(a.width, a.height))
        },
        buildPlaypause: function() {
            function c(c) {
                (a.media.isUserClick || a.options.autoplay) && ("play" === c ? (e(b, "zy_play"),
                d(b, "zy_pause")) : (e(b, "zy_pause"),
                d(b, "zy_play")))
            }
            var a = this
            ...
            b.addEventListener("click", function() {
                ...
                a.media.paused ? (a.media.play(),
                a.media.paused || a.options.alwaysShowControls || a.setControlsTimer(3e3)) : a.media.pause()
            }),
        ...
        buildTimeline: function() {
            ...
            j = function(a) {
                ...
                c.media.duration && (g > d ? d = g : d > h + g && (d = h + g),
                c.handle.style.left = d - i - g + "px",
                b = (d - g) / h * c.media.duration,
                c.currentTime.innerHTML = f(c.media.currentTime, c.options),
                e && b !== c.media.currentTime && (c.media.currentTime = b))
            }
            ,
            a.features.hasTouch ? c.slider.addEventListener("touchstart", function(a) {
                ...
                c.slider.addEventListener("touchend", function() {
                    e = !1,
                ...
                c.slider.addEventListener("mouseup", function() {
                    e = !1,
                    c.slider.addEventListener("mousemove", j)
                })
            }),
        ...
        buildTime: function() {
            ...
            a.media.addEventListener("timeupdate", function() {
                a.updateTime()
            })
        },
        buildFullscreen: function() {
            ...
            b.fullscreenBtn.addEventListener("click", function() {
        ...
        buildDec: function() {
            ...
            a.features.isVendorBigPlay || (e.className = "dec_play",
            ...
            b.media.addEventListener("play", function() {
                b.media.isUserClick && (e.style.display = "none",
                c.style.display = "",
        ...
        init: function() {
            ...
            for (b.options.enableFullscreen && !a.features.isVendorFullscreen && b.isVideo && c.push("Fullscreen"),
            b.isVideo && c.push("Dec"),
            d = 0; d < c.length; d++)
                try {
                    b["build" + c[d]]()
                } catch (e) { }
            ...
            b.options.hideVideoControlsOnLoad && b.hideControls(),
            ...
            b.media.addEventListener("play", function() {
                ...
                for (d in a.players)
                    if (c = a.players[d],
                    c.id != b.id && b.options.pauseOtherPlayers && !c.paused && !c.ended)
                        try {
                            c.media.pause()
                        } catch (e) { }
            }),
            ...
            b.options.autoplay && (b.media.isUserClick = !1,
            b.media.play()),
